...
This folder contains an old source files of the LDSC container originally developed by Bayram Akdeniz.
These files and instructions are obsolete and should not be used.
